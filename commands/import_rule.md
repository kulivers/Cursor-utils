...
Автоматически анализирует проект, находит подходящие правила из `awesome-cursor-rules-mdc/rules-mdc/` и импортирует их в `.cursor/rules/`.
...
1. **Найди директорию с правилами:**
   - Путь: `awesome-cursor-rules-mdc/rules-mdc/`
...
2. **Для каждого найденного правила:**
   ...
   - Если не существует, скопируй файл из `awesome-cursor-rules-mdc/rules-mdc/` в `.cursor/rules/`
